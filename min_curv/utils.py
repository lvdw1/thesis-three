...
from plot_mincurv import plot_optimisation, plot_preprocessing
...
def calc_bound_dists(
    ...
    #     print("Track width was manipulated to enforce minimum track width!")
...
def boundary_check(
    ...
    print(f"Max distance left cones to left boundary: {max_distance_left_cones}")
    print(
...
def iqp_mincurv_handler(
    ...
    while True:
        ...
        print("Iteration %d of IQP started...", iter_cur)
