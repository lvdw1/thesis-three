...
/* bicycle_model_constr_h_fun:(i0[6],i1[3],i2[],i3[218])->(o0) */
...
CASADI_SYMBOL_EXPORT int bicycle_model_constr_h_fun_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
